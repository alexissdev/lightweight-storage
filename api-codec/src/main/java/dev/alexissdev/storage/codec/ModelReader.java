...
public interface ModelReader<R> {
    ...
    /**
     * Reads a String from the current row and converts it to a UUID
     *
     * @param field
    ...
    /**
     * It reads a list of objects from the document and returns them as a set
     *
     * @param field
     * 	The field name in the document.
     * @param clazz
     * 	The class of the type of the elements of the set.
     *
    ...
    default <T extends Enum<T>> @Nullable T readEnum(@NotNull String field,
    ...
    /**
     * Reads a field from the document and returns it as a float
     *
     * @param field
     * 	The field to read.
     *
    ...
    /**
     * Reads the value of the field from the document and returns it as an integer
     *
     * @param field
     * 	The field to read.
     *
     ...
     *
     * @param field
     * 	The field name to read from the document.
     * @param clazz
     * 	The class of the type you want to read.
     *
    ...
    /**
     * If the document has a field with the given name, parse it using the given parser
     *
     * @param field
     * 	The name of the field to read.
     * @param parser
     * 	A function that takes a DocumentReader and returns a DocumentCodec.
     *
    ...
    /**
     * It reads a list of documents from the given field, and parses each document into a key-value
     * pair using the given key and value parsers
     *
     * @param field
     * 	The name of the field to read.
     * @param keyParser
     * 	A function that takes a DocumentCodec and returns a key.
     * @param valueParser
     * 	A function that takes a DocumentReader and returns a value of type V.
     *
     ...
     *
     * @param field
     * 	The name of the field in the document that contains the list of children.
     * @param parser
     * 	A function that takes a DocumentReader and returns a DocumentCodec.
     *
