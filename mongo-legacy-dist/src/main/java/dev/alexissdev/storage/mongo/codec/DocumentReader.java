...
/**
 * A utility class for reading and extracting data from a {@link Document} object.
 *
 * <p>This class implements the {@link ModelReader} interface for the {@link Document} type
 * and provides methods to read various data types, including primitive types, collections,
 * and nested objects, from the wrapped {@link Document} instance. It allows structured access
 * to the fields within a {@link Document}, adhering to the contract defined in {@link ModelReader}.
 *
 * <p>Instances of this class are created using the static factory method {@code create(Document)}.
 * The class is designed to provide a consistent interface for data access across different
 * parts of an application that use {@link Document} as a data source.
 */
