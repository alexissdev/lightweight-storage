...
/**
 * A utility class for reading YAML configurations and converting them into structured objects
 * according to the {@link ModelReader} interface.
 *
 * This class is designed to work with a parent {@link ConfigurationSection} object to provide
 * convenient methods for extracting data in various formats, including primitives, lists,
...
public class YamlReader
    ...
    @Override
    public <T extends ModelCodec<Map<String, Object>>> @Nullable T readChild(String field, Function<ModelReader<Map<String, Object>>, T> parser) {
        ConfigurationSection section = parentSection.getConfigurationSection(field);
    ...
    @Override
    public <K, V extends ModelCodec<Map<String, Object>>> Map<K, V> readMap(String field, Function<V, K> keyParser,
